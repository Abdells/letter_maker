...
export default function PreviewPage() {
  ...
  // This replaces usePaystackPayment — calls Paystack directly via their inline JS
  // which correctly closes its own popup after payment
  const openPaystack = (action: 'read' | 'download') => {
    setPendingAction(action);
    setShowPaymentModal(false); // close our custom modal before opening Paystack popup
  ...
  // FIX: New download approach — API returns base64 JSON, we decode it client-side
  // This reliably works on Vercel where raw binary responses cause 204/empty issues
